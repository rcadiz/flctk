stereoize(p) = S(inputs(p), outputs(p))
			    ...
			    process = vgroup("Whistles",(stereoize(environment{process = vgroup("Whistles",environment{declare name "Whistles";
declare author "ER";
declare version "1.0";
...
}.process);}.process):> stereoize(environment{process=_,_;}.process)));