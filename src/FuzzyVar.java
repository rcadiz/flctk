...
public class FuzzyVar {
	...
	*/
	...
	/**
	* Constructor that takes the number of membership functions
	* @param numf number of membership functions
	*/
	public FuzzyVar(int numf) {
		nmfunctions = numf;
		name = new String("Default var");
		empty = true;
		size = defaultSize;
	...
	/**
	* Constructor with number of membership functions and name
	* @param numf number of membership functions
	* @param name name of the fuzzy variable
	*/
	public FuzzyVar(int numf, String name) {
		nmfunctions = numf;
		this.name = name;
		empty = true;
		size = defaultSize;
	...
	*/
	...
	/**
	* Updates inputs degrees from membership functions
	* @param X
	*/
	public void updateInputDegrees(double X)  {
		...
		for(int i=0; i<nmfunctions; i++) {
			...
			//System.out.println("input degree " + inputDegrees[i]);
		}
	}
